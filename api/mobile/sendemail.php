...
// Pastikan Anda sudah menginstall PHPMailer dan autoload.php tersedia
    ...
    if (isset($data['email'])) {
        ...
        function sendOTP($recipientEmail, $otp) {
            ...
            try {
                ...
                $mail->Password = 'kcqvqnkddtbzjdy'; // Kata sandi Gmail atau App Password Anda
        ...
        if (sendOTP($recipientEmail, $otp)) {
            echo json_encode([
                ...
                // Opsi: jangan tampilkan OTP ini di response dalam produksi.
                'otp' => $otp // Untuk keperluan debugging, sebaiknya hapus ini di produksi
            ]);
        } else {
            echo json_encode([
                'status' => 'error',
